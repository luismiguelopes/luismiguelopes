...
<head>
    ...
    <meta name="description" content="luismiguelopes Portfolio">
...
<div class="body">
                                        ...
                                        <ul class="nav" id="mainNav">
                                            <li>
                                                <a data-hash href="#about-me" class="text-color-dark background-color-primary">
                                                    ...
                                                    <span class="custom-tooltip">Sobre Mim</span>
                                                </a>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <a data-hash href="#skills" class="text-color-dark background-color-primary">
                                                    ...
                                                    <span class="custom-tooltip">Competências</span>
                                                </a>
                                            </li>
                                            <li>
    ...
    <div role="main" class="main">
        ...
        <section id="about-me" class="section section-no-border section-parallax custom-section-padding-1 custom-position-1 custom-xs-bg-size-cover m-none" data-plugin-parallax data-plugin-options="{'speed': 1.5}" data-image-src="img/me.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-sm-4 col-xs-10 col-sm-offset-0 col-xs-offset-1 custom-sm-margin-bottom-1">
                        <img src="img/demos/resume/about-me/me.jpg" class="img-responsive custom-border custom-image-position-2 custom-box-shadow-4" alt />
                    </div>
                    <div class="col-md-5 col-sm-8">
                        ...
                        <span class="custom-about-me-infos">
								<span class="custom-text-color-1 text-uppercase">HostingZard</span>
								<span class="custom-text-color-1 text-uppercase mb-md">Server Manager &amp; Web Developer</span>
								<span class="custom-text-color-1 text-uppercase">
									<strong class="text-color-light">De momento: </strong>
									GirlsVinci Web Developer
                        ...
                        <div class="custom-box-details background-color-light custom-box-shadow-1 col-md-6 ml-xlg mb-xlg pull-right clearfix">
                            ...
                            <div class="col-md-6 col-sm-6 p-none">
                                <ul class="custom-list-style-1 p-none">
                                    <li>
                                        <span class="text-color-dark">DATA NASCIMENTO:</span>
                                        <span class="custom-text-color-2">15 Maio 1988</span>
                                    </li>

                                    <li>
                                        <span class="text-color-dark">Nacionalidade:</span>
                                        <span class="custom-text-color-2">Portuguesa</span>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-md-6 col-sm-6 p-none">
                                ...
                                <article class="timeline-box right custom-box-shadow-2">
                                    <div class="experience-info col-md-3 col-sm-5 match-height background-color-primary">
											<span class="from text-color-dark text-uppercase">
												...
												<span class="font-weight-semibold">Abr 2015</span>
											</span>
                                        <span class="to text-color-dark text-uppercase">
                                        ...
                                        <span class="company text-color-dark font-weight-semibold">
												ImplodeCode
												<span class="company-location text-color-dark font-weight-normal text-uppercase">Hobbie</span>
											</span>
                                    </div>
                                    <div class="experience-description col-md-9 col-sm-7 match-height background-color-light">
                                ...
                                <article class="timeline-box right custom-box-shadow-2">
                                    <div class="experience-info col-md-3 col-sm-5 match-height background-color-primary">
											<span class="from text-color-dark text-uppercase">
												...
												<span class="font-weight-semibold">Fev 2012</span>
											</span>
                                        <span class="to text-color-dark text-uppercase">

												<span class="font-weight-semibold">Presente</span>
											</span>
                                        <p class="text-color-dark">(5 Anos)</p>
                                        <span class="company text-color-dark font-weight-semibold">
												GirlsVinci
												<span class="company-location text-color-dark font-weight-normal text-uppercase">Carcavelos</span>
											</span>
                                    </div>
                                    <div class="experience-description col-md-9 col-sm-7 match-height background-color-light">
                                        <h4 class="text-color-dark font-weight-semibold">Web Developer</h4>
                                        ...
                                        <div class="image-gallery-item">
                                            <a href="img/demos/resume/portfolio/portfolio-4.jpg" class="lightbox-portfolio">
													<span class="thumb-info custom-thumb-info-1">
														<span class="thumb-info-wrapper">
															<span class="thumb-info-plus"></span>
															<img src="img/demos/resume/portfolio/portfolio-4.jpg" class="img-responsive" alt="">
														</span>
													</span>
                                            </a>
                                        </div>
                                        ...
                                        <div class="image-gallery-item">
                                            <a href="img/demos/resume/portfolio/portfolio-6.jpg" class="lightbox-portfolio">
													<span class="thumb-info custom-thumb-info-1">
														<span class="thumb-info-wrapper">
															<span class="thumb-info-plus"></span>
															<img src="img/demos/resume/portfolio/portfolio-6.jpg" class="img-responsive" alt="">
														</span>
													</span>
                                            </a>
                                        </div>
                                        ...
                                        <div class="image-gallery-item">
                                            <a href="img/demos/resume/portfolio/portfolio-7.jpg" class="lightbox-portfolio">
													<span class="thumb-info custom-thumb-info-1">
														<span class="thumb-info-wrapper">
															<span class="thumb-info-plus"></span>
															<img src="img/demos/resume/portfolio/portfolio-7.jpg" class="img-responsive" alt="">
														</span>
													</span>
                                            </a>
                                        </div>
                                        ...
                                        <div class="image-gallery-item">
                                            <a href="img/demos/resume/portfolio/portfolio-8.jpg" class="lightbox-portfolio">
													<span class="thumb-info custom-thumb-info-1">
														<span class="thumb-info-wrapper">
															<span class="thumb-info-plus"></span>
															<img src="img/demos/resume/portfolio/portfolio-8.jpg" class="img-responsive" alt="">
														</span>
													</span>
                                            </a>
                                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-10 col-sm-offset-1 col-md-offset-0 custom-sm-margin-bottom-1">
                        <article class="thumb-info custom-thumb-info-2 custom-box-shadow-1 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="0" data-appear-animation-duration="1s">
								<span class="thumb-info-wrapper">
									<a href="#">
										<img src="img/demos/resume/blog/blog-1.jpg" alt class="img-responsive" />
									</a>
								</span>
                    ...
                    <div class="col-md-6 col-sm-10 col-sm-offset-1 col-md-offset-0">
                        <article class="thumb-info custom-thumb-info-2 custom-box-shadow-1 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="0" data-appear-animation-duration="1s">
								<span class="thumb-info-wrapper">
									<a href="#">
										<img src="img/demos/resume/blog/blog-2.jpg" alt class="img-responsive" />
									</a>
								</span>
                            <span class="thumb-info-caption">
									<span class="thumb-info-caption-text">
                                ...
                                <form id="callSendMessage" class="custom-form-style" action="#" method="POST">
                                    <div class="form-content">
                                        <div class="form-control-custom">
                                            <input type="text" class="form-control" name="callName" placeholder="Nome *" data-msg-required="This field is required." id="callName" required="" />
                                        </div>
                                        <div class="form-control-custom">
                                            <input type="text" class="form-control" name="callSubject" placeholder="Assunto *" data-msg-required="This field is required." id="callSubject" required="" />
                                        </div>
                                        <div class="form-control-custom">
                                            <textarea maxlength="5000" data-msg-required="Please enter your message." rows="10" class="form-control" name="message" placeholder="Mensagem *" id="message" required="" aria-required="true"></textarea>
                                        </div>
                                ...
                                <a href="mailto:you@domain.com" class="text-decoration-none">
										<span class="feature-box custom-feature-box mb-xlg">
											...
											<span class="feature-box-info">
												...
												<strong class="font-weight-light text-color-light custom-opacity-effect-1">geral@luismiguelopes.com</strong>
											</span>
										</span>
                                </a>
                                <a href="tel:+1234657890" class="text-decoration-none">
										<span class="feature-box custom-feature-box mb-xlg">
											...
											<span class="feature-box-info">
												...
												<strong class="font-weight-light text-color-light custom-opacity-effect-1">91 521 22 77</strong>
											</span>
										</span>
                                </a>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 m-none">
                            <p class="custom-text-color-2">© 2017 luismiguelopes. Todos os Direitos Reservados.</p>
                        </div>
                    </div>
                </div>
            </div>
