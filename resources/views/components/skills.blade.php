    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6 col-lg-8 mb-4 mb-md-0">
                <div class="row">
                    <div class="col-lg-6">
                        <h2 class="text-color-dark text-uppercase font-weight-extra-bold">{{ __('skills.skills') }}</h2>
                ...
                <div class="row">
                    <div class="col">
                        <div class="custom-box-details bg-color-light custom-box-shadow-1">
                            <h4 class="text-color-dark">{{ __('skills.Languages') }}</h4>
                            <ul class="custom-list-style-1 p-0">
                                <li>
                                    <span class="font-weight-semibold custom-max-width-1 text-color-dark"><img src="img/blank.gif" class="flag flag-us me-1" alt="English">{{ __('skills.English') }}:</span>
                                    <span class="custom-text-color-2">{{ __('skills.Advanced') }}</span>
                                </li>
                                <li>
                                    <span class="font-weight-semibold custom-max-width-1 text-color-dark"><img src="img/blank.gif" class="flag flag-pt me-1" alt="Portuguese">{{ __('skills.Portuguese') }}:</span>
                                    <span class="custom-text-color-2">{{ __('skills.Advanced') }}</span>
                                </li>
                                <li>
                                    <span class="font-weight-semibold custom-max-width-1 text-color-dark"><img src="img/blank.gif" class="flag flag-es me-1" alt="Spanish">{{ __('skills.Spanish') }}:</span>
                                    <span class="custom-text-color-2">{{ __('skills.Basic') }}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
